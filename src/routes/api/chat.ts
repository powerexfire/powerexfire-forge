...
const SYSTEM_PROMPT = `You are "Powerex Assistant", the friendly AI assistant for Powerex Fire Protection System — a fire safety company based in Vasai East, Vasai-Virar, Maharashtra, India, founded in 2010 by Santosh Kumar Yadav (GSTIN 27ABKPY1137F1ZH).
        ...
        try {
          ...
          if (!reply) {
            return Response.json(
              { error: "The assistant didn't return an answer. Please try again." },
              { status: 502 },
            );
          }
          ...
          return Response.json(
            { error: "Network error contacting the assistant. Please try again." },
            { status: 502 },
          );
        }
      },
